...
df_humidity = pd.read_csv('humidity.csv')[['datetime', 'Los Angeles', 'Houston']]
df_humidity.columns = ['datetime', 'humid_LA', 'humid_HO']

df_pressure = pd.read_csv('pressure.csv')[['datetime', 'Los Angeles', 'Houston']]
df_pressure.columns = ['datetime', 'press_LA', 'press_HO']

df_temperature = pd.read_csv('temperature.csv')[['datetime', 'Los Angeles', 'Houston']]
df_temperature.columns = ['datetime', 'temp_LA', 'temp_HO']

df_wind_dir = pd.read_csv('wind_direction.csv')[['datetime', 'Los Angeles', 'Houston']]
df_wind_dir.columns = ['datetime', 'dir_LA', 'dir_HO']

df_wind_speed = pd.read_csv('wind_speed.csv')[['datetime', 'Los Angeles', 'Houston']]
